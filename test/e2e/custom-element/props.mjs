...
createCustomElement('mock-props', {
  props: {
    displayString: {
      type: String
    },
...
createCustomElement('mock-props-default', {
  props: {
    displayString: {
      type: String,
...
createCustomElement('mock-props-default-number', {
  props: {
    count: {
      type: Number,
      default: 0
...
createCustomElement('mock-props-default-boolean-true', {
  props: {
    hasLoaded: {
      type: Boolean,
      default: true
...
createCustomElement('mock-props-default-object', {
  props: {
    config: {
      type: Object,
      default: {
...
createCustomElement('mock-props-required', {
  props: {
    displayString: {
      type: String,
      required: true
...
createCustomElement('mock-props-observed', {
  props: {
    displayString: {
      type: String
    }
...
createCustomElement('mock-props-not-observed', {
  props: {
    displayString: {
      type: String,
      observed: false
...
createCustomElement('mock-props-multiple-container', {
  state () {
    return {
      loading: false,
      error: null,
...
createCustomElement('mock-props-multiple', {
  props: {
    apple: {
      type: String,
      observed: true
